...
class SecondPaper:
    ...
    def bar3D_plot(self):
        ...
        ax.bar3d(self.ll.flatten(), self.nn.flatten(), np.zeros(self.final_k_stern().size),
                 ...
                 self.final_k_stern_values().flatten(), shade=True, color=colors, linewidth=0, edgecolor='w', facecolors="w")
...
final_k_stern = wp2.final_k_stern_values()
k_stern = wp2.final_k_stern()
# wp2.suface_plot()
wp2.bar3D_plot()
